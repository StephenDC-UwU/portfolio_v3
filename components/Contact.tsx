...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="section section-contact relative w-full min-h-screen overflow-hidden transition-colors duration-500 bg-bg-primary"
    >
      <div className="section-content w-full h-full relative">
        <div className="section-inner w-full min-h-screen flex flex-col justify-between pt-24 sm:pt-32 px-4 sm:px-8 md:px-14 relative">
          ...
          {/* Footer at the bottom of the final slide */}
          <Footer />
        </div>
      </div>
    </section>
